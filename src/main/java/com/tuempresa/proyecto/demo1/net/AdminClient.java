...
public class AdminClient {
    ...
    private void connectAndListen() {
        try {
            ...
            // IMPORTANT: The ObjectOutputStream must be created BEFORE the ObjectInputStream
            // to avoid a deadlock when the server does the same.
    ...
    private void sendCommand(String command) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(frame, "Failed to send command: " + e.getMessage(), "Communication Error", JOptionPane.ERROR_MESSAGE);
        }
    }
